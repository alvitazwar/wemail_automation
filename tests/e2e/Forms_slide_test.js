...
Scenario('Form_Creation', ({ I }) => {
  ...
  I.fillField('//*[@id="wemail-admin"]/div/div[2]/div/div/form/fieldset/div[2]/label[1]/input','Slide');
  I.click('//*[@id="wemail-admin"]/div/div[2]/div/div/form/fieldset/div[2]/label[2]/div/div[3]/a/span[1]'); //Select form type
