...
Scenario('Form_Creation', (I) => {
  ...
  I.fillField('//*[@id="wemail-admin"]/div/div[2]/div/div/form/fieldset/div[2]/label[1]/input','Inline');
  I.click('//*[@id="wemail-admin"]/div/div[2]/div/div/form/fieldset/div[2]/label[2]/div/div[1]/a/span[1]'); //Select form type
